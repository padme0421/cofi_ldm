...
class CoFi_LDM_Trainer:
    ...
    def generate_custom(self, prompt: str, response_embeddings,
        ...
        for _ in range(block_size):
            ...
            outputs = model(
                inputs_embeds=torch.cat([prompt_embeds, generated_embeds], dim=1),
    ...
    def training_step(self, inputs):
        ...
        gold_blocks = gold_response_ids.reshape(num_blocks, block_size)
        ...
        full_input_embeds = torch.cat([prompt_embeds, ar_embeds], dim=1) # [num_blocks, block_size, dim]
